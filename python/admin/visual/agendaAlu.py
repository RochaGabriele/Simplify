"""
@author:José Maik, Jefferson Oliveira, Gabriele Rocha
...
class agendaAlu():
    def __init__(self):
        ...
        builder.add_from_file("admin/visual/ageAlu.glade")
        ...
        "dados ALuno"
        self.labNomAlu = builder.get_object("labNomAlu")
        self.labMatUser = builder.get_object("labMatUser")
        self.labSerUser = builder.get_object("labSerUser")
        self.labCursoUser = builder.get_object("labCursoUser")
